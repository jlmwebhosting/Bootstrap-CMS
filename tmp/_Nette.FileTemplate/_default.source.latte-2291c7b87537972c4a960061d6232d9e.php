...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb394936f417_content')) { function _lb394936f417_content($_l, $_args) { extract($_args)
